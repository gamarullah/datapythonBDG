...
list.files("D:/additional/R/kaggle/titanic")

# Any results you write to the current directory are saved as output.
# read the training data
df = read.csv("D:/additional/R/kaggle/titanic/train.csv", header = T)

# read the test data
df_test = read.csv("D:/additional/R/kaggle/titanic/test.csv", header = T)
...
testData = read.csv("D:/additional/R/kaggle/titanic/test.csv", header = T)
